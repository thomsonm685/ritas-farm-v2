...
const OrderCard = ({
  ...
  const getSkippedProducts = (e) => {
    ...
    console.log("skipped from function:", skippedProducts);
  ...
  const checkIfChecked = (e) => {
    ...
    if (allChecked) {
      ...
      if (order.lineItems[shelfIndex + 1] === undefined) return;
      if (order.lineItems[shelfIndex + 1][0].sku === null) return;
      setCurrentShelf(order.lineItems[shelfIndex + 1][0].sku);
