const downloadSkuOneCsv = async ({ orderData }) => {
  let rows = [];
  // Data In Columns
  orderData
    .filter((workerObj) => workerObj.worker === "Sku 1")[0]
  ...
  link.setAttribute("download", `SKU-1-Orders-${theDate}.csv`);
...
export default downloadSkuOneCsv;
