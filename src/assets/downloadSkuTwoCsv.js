const downloadSkuTwoCsv = async ({ orderData }) => {
  let rows = [];
  // Data In Columns
  orderData
    .filter((workerObj) => workerObj.worker === "Sku 2")[0]
  ...
  link.setAttribute("download", `SKU-2-Orders-${theDate}.csv`);
...
export default downloadSkuTwoCsv;
